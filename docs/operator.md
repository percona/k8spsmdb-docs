...
| **Description** | Name of the separate privileged service account used by the Operator; **service account for backups is not used by the Operator any more, and is deprecated since the Operator version 1.16.0** |
|                 | |
