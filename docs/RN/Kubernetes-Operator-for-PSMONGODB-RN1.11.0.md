...
* In addition to S3-compatible storage, you can now configure backups [to use Microsoft Azure Blob storage](../backups-storage-azure.md). This feature makes the Operator fully compatible with Azure Cloud.
