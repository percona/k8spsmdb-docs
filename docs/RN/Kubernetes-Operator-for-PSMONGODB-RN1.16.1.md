...
* {{ k8spsmdbjira(1101) }}: Fix a bug where manually generated TLS certificates couldn't be applied because Operator was replacing them with auto-generated ones
