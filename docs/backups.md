...
Also you can use [prefix](operator.md#backup-storages-s3-prefix) option to specify the
...
You can use [prefix](operator.md#backup-storages-azure-prefix) option to specify the
...
[backup.pitr.enabled](operator.md#backup-pitr-enabled) key in the `deploy/cr.yaml`
configuration file:
...
[backup.tasks.keep](operator.md#backup-tasks-keep) option (only successful backups are
