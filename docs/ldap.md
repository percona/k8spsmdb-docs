...
know more about LDAP concepts and [LDIF :material-arrow-top-right:](https://en.wikipedia.org/wiki/LDAP_Data_Interchange_Format)
files used to configure it, and find how to install and configure OpenLDAP in
the official [OpenLDAP :material-arrow-top-right:](https://www.openldap.org/doc/admin26/) and
[Percona Server for MongoDB :material-arrow-top-right:](https://docs.percona.com/percona-server-for-mongodb/latest/authentication.html)
documentation.

## The OpenLDAP side

You can add needed OpenLDAP settings will the following [LDIF :material-arrow-top-right:](https://en.wikipedia.org/wiki/LDAP_Data_Interchange_Format)
portions:
...
!!! note
    ...
    If you are not sure about the approach to make references between user and group objects, [OpenDAP overlays :material-arrow-top-right:](https://www.openldap.org/doc/admin24/overlays.html) provide one of the possible ways to go.
...
=== "if sharding is off"
    ...
    * Internal mongodb role
    ...
    !!! note
        ...
        [LDAP over TLS :material-arrow-top-right:](https://www.openldap.org/faq/data/cache/185.html) is not yet
