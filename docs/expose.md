...
The Operator provides entry points for accessing the database by client applications in several scenarios. In either way the cluster is exposed with regular Kubernetes [Service objects :material-arrow-top-right:](https://kubernetes.io/docs/concepts/services-networking/service/), configured by the Operator.
...
You can find more on sharding in the [official MongoDB documentation :material-arrow-top-right:](https://docs.mongodb.com/manual/reference/glossary/#term-sharding).
...
can assign a [Kubernetes Service :material-arrow-top-right:](https://kubernetes.io/docs/concepts/services-networking/service/)
to each Pod.
...
[Split-horizon DNS :material-arrow-top-right:](https://en.wikipedia.org/wiki/Split-horizon_DNS) provides
